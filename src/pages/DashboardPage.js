...
export function DashboardPage() {
    ...
    const { calendarStatus, calendarConnections, conferencingRuntime, conferencingStatus, calendarCapabilities, conferencingCapabilities, loading: integrationsLoading, error: integrationsError, banner, clearBanner, getCalendarProviderStatus, getConferencingProviderStatus, startConnect, disconnectProvider, pendingAction, refreshStatus, } = useIntegrationState();
    ...
    const copyEventTimeoutRef = useRef(null);
    ...
    const handleCopyEventLink = useCallback(async (eventId, url) => {
        try {
    ...
    const loadMeetings = useCallback(async (_hostId) => {
        try {
    ...
    return (_jsxs("div", { className: "dash-root", children: [_jsxs(DashboardWorkspaceChrome, { section: section, path: path, brandHref: brandHref, firstName: firstName, meetingsCount: meetingBuckets.upcoming.length || undefined, eventsCount: events.length || undefined, userName: user?.name || user?.email || "User", userEmail: user?.email || "host", userAvatarUrl: user?.profileImage, avatarFailed: avatarFailed, menuOpen: menuOpen, logoutLoading: logoutLoading, onMenuToggle: () => setMenuOpen((p) => !p), onAvatarError: () => setAvatarFailed(true), onMenuClose: () => setMenuOpen(false), onLogout: handleLogout, children: [section === "meetings" && (_jsxs(_Fragment, { children: [_jsxs("div", { className: "mt-grid", children: [_jsxs("section", { className: "allclear", "aria-label": "Next up", children: [_jsx("div", { className: "allclear-copy", children: nextMeeting ? (_jsxs(_Fragment, { children: [_jsx("span", { className: "eyebrow", children: "Next up" }), _jsxs("h2", { children: [formatRelativeDay(nextMeeting.startTime), "."] }), _jsxs("p", { children: [new Date(nextMeeting.startTime).toLocaleDateString("en-US", { weekday: "short", month: "short", day: "numeric" }), " · ", formatWindow(nextMeeting.startTime, nextMeeting.endTime).time, " · ", nextMeeting.guestName] }), _jsxs("div", { className: "allclear-actions", children: [_jsx("button", { className: "dash-btn-primary", style: { borderRadius: 999, fontSize: 12.5, padding: "7px 14px" }, onClick: () => setSelectedMeeting(nextMeeting), children: "Details" }), _jsxs("span", { className: "mt-chip ok", style: { marginLeft: 2 }, children: [_jsx("span", { className: "d" }), nextMeeting.bookingStatus] })] })] })) : (_jsxs(_Fragment, { children: [_jsx("span", { className: "eyebrow", children: "Next up" }), _jsx("h2", { children: "All clear." }), _jsx("p", { children: "No upcoming meetings scheduled. Your calendar is yours." }), _jsxs("div", { className: "allclear-actions", children: [_jsx(Link, { to: "/onboarding/event", className: "dash-btn-primary", style: { borderRadius: 999, fontSize: 12.5, padding: "7px 14px", textDecoration: "none" }, children: "Share your booking link" }), _jsx(Link, { to: "/dashboard/availability", className: "dash-btn-secondary", style: { borderRadius: 999, fontSize: 12.5, padding: "7px 14px", textDecoration: "none" }, children: "Set availability" })] })] })) }), _jsxs("div", { className: "mt-bunny-nook", "aria-hidden": "true", children: [_jsxs("span", { className: "bunny-tag", children: [_jsx("span", { className: "zsleep", children: "z z" }), " resting easy"] }), _jsx(BunnyMascot, {})] })] }), _jsxs("div", { className: "mt-stats", children: [_jsxs("div", { className: "stat", children: [_jsx("span", { className: "chip-sq today" }), _jsx("span", { className: "lbl", children: "Today" }), _jsx("span", { className: "num", children: todayCount }), _jsx("span", { className: "sub", children: "meetings scheduled" })] }), _jsxs("div", { className: "stat", children: [_jsx("span", { className: "chip-sq upcoming" }), _jsx("span", { className: "lbl", children: "Upcoming" }), _jsx("span", { className: "num", children: meetingBuckets.upcoming.length }), _jsx("span", { className: "sub", children: "total confirmed" })] }), _jsxs("div", { className: "stat", children: [_jsx("span", { className: "chip-sq hidden" }), _jsx("span", { className: "lbl", children: "Hidden" }), _jsx("span", { className: "num", children: hiddenMeetingIds.length }), hiddenMeetingIds.length > 0 ? (_jsx("button", { onClick: clearHiddenMeetings, style: { fontSize: 12, color: "var(--plum-500)", textDecoration: "underline", background: "none", border: "none", padding: 0, cursor: "pointer", fontFamily: "var(--sans)", width: "fit-content" }, children: "Restore" })) : (_jsx("span", { className: "sub", children: "archived meetings" }))] })] })] }), _jsxs("div", { className: "mt-chips", children: [_jsxs("span", { className: clsx("mt-chip", events.length > 0 ? "ok" : "warn"), children: [_jsx("span", { className: "d" }), events.length > 0 ? `${events.length} event type${events.length > 1 ? "s" : ""} ready` : "No event types"] }), _jsxs("span", { className: clsx("mt-chip", connectedProviderCount > 0 ? "ok" : "warn"), children: [_jsx("span", { className: "d" }), connectedProviderCount > 0 ? `${connectedProviderCount} integration${connectedProviderCount > 1 ? "s" : ""} active` : "No integrations connected"] })] }), _jsxs("section", { className: "mt-list", children: [_jsxs("div", { className: "mt-list-head", children: [_jsxs("h3", { children: ["Your ", _jsx("em", { children: "meetings" })] }), _jsxs("div", { className: "mt-tabs", children: [_jsxs("button", { className: clsx("mt-tab", meetingTab === "upcoming" && "active"), onClick: () => setMeetingTab("upcoming"), children: ["Upcoming (", meetingBuckets.upcoming.length, ")"] }), _jsxs("button", { className: clsx("mt-tab", meetingTab === "past" && "active"), onClick: () => setMeetingTab("past"), children: ["Past (", meetingBuckets.past.length, ")"] }), _jsxs("button", { className: clsx("mt-tab", meetingTab === "cancelled" && "active"), onClick: () => setMeetingTab("cancelled"), children: ["Cancelled (", meetingBuckets.cancelled.length, ")"] })] })] }), meetingsError && (_jsxs("div", { className: "dash-alert error", children: [_jsx("span", { children: meetingsError }), user?.id && (_jsx("button", { className: "dash-btn-secondary", style: { fontSize: 12.5, padding: "5px 12px" }, onClick: () => void loadMeetings(user.id), children: "Retry" }))] })), meetingsLoading ? (_jsx("div", { children: Array.from({ length: 4 }).map((_, i) => (_jsx("div", { className: "dash-skel", style: { height: 88, marginBottom: 12 } }, i))) })) : displayedMeetings.length === 0 ? (_jsxs("div", { className: "mt-empty", children: [_jsx("div", { className: "seed" }), _jsxs("h4", { children: ["No ", meetingTab, " meetings"] }), _jsx("p", { children: "This view is clear right now. New bookings will land here automatically." })] })) : (_jsx("div", { className: "meet-list", children: displayedMeetings.map((meeting) => {
                                            ...
                                            return (_jsxs("div", { className: "meet-row", style: terminalExternalDelete ? { borderLeft: "3px solid var(--blush)" } : undefined, children: [_jsxs("div", { className: "when", children: [_jsx("span", { className: "rel", children: dayTone }), _jsx("span", { className: "day", children: new Date(meeting.startTime).toLocaleDateString("en-US", { month: "short", day: "numeric" }) }), _jsx("span", { className: "time", children: when.time })] }), _jsxs("div", { className: "who", children: [_jsxs("span", { className: "name", children: [meeting.guestName, " \u00B7 ", meeting.eventTypeName] }), _jsx("span", { className: "ev", children: meeting.guestEmail }), lifecycle && (_jsx("span", { className: "ev", style: { fontSize: 12, color: terminalExternalDelete ? "#991B1B" : "var(--plum-400)" }, children: lifecycle.detail }))] }), _jsxs("div", { className: "badges", children: [_jsxs("span", { className: clsx("dbadge", opStatus === BookingLifecycleStatus.CONFIRMED && "ok", opStatus === BookingLifecycleStatus.PENDING && "hold", opStatus === BookingLifecycleStatus.CANCELLED && "danger"), children: [_jsx("span", { className: "dot" }), terminalExternalDelete ? `Local: ${meeting.bookingStatus}` : opStatus] }), !terminalExternalDelete && (_jsxs("span", { className: clsx("dbadge", sync.tone === "good" && "synced", sync.tone === "warn" && "hold", sync.tone === "bad" && "danger"), children: [_jsx("span", { className: "dot" }), sync.label] }))] }), _jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 6, alignItems: "flex-end" }, children: [actions.slice(0, 1).map((action) => (_jsx("a", { href: action.url, target: "_blank", rel: "noreferrer", className: "dash-btn-secondary", style: { fontSize: 12.5, padding: "5px 12px" }, children: action.label }, action.id))), _jsx("button", { className: "dash-btn-secondary", style: { fontSize: 12.5, padding: "5px 12px" }, onClick: () => setSelectedMeeting(meeting), children: "Details" }), (opStatus === BookingLifecycleStatus.EXPIRED || opStatus === BookingLifecycleStatus.CANCELLED || dayTone === "Past") && (_jsx("button", { className: "dash-btn-secondary", style: { fontSize: 11.5, padding: "3px 10px", opacity: 0.65 }, onClick: () => hideMeeting(meeting.bookingId), children: "Hide" }))] })] }, meeting.bookingId));
                                                    ...
                                                    return (_jsxs("div", { className: "avail-day-row", children: [_jsx("div", { style: { fontWeight: 500, color: "var(--plum-900)", fontSize: 14 }, children: dayLabel }), _jsxs("div", { className: "dash-field", children: [_jsx("label", { children: "Start" }), _jsx("input", { type: "time", value: weeklyRules[day].startTime, onChange: (e) => setWeeklyRules((prev) => ({ ...prev, [day]: { ...prev[day], startTime: e.target.value } })), disabled: !weeklyRules[day].enabled, className: "dash-input" })] }), _jsxs("div", { className: "dash-field", children: [_jsx("label", { children: "End" }), _jsx("input", { type: "time", value: weeklyRules[day].endTime, onChange: (e) => setWeeklyRules((prev) => ({ ...prev, [day]: { ...prev[day], endTime: e.target.value } })), disabled: !weeklyRules[day].enabled, className: "dash-input" })] }), _jsxs("label", { style: { display: "flex", alignItems: "center", gap: 8, fontSize: 13.5, color: "var(--plum-500)", paddingTop: 22, cursor: "pointer" }, children: [_jsx("input", { type: "checkbox", checked: weeklyRules[day].enabled, onChange: (e) => setWeeklyRules((prev) => ({ ...prev, [day]: { ...prev[day], enabled: e.target.checked } })), style: { accentColor: "var(--lilac)", width: 16, height: 16 } }), "Active"] })] }, day));
                                                        ...
                                                        }) }))] }), _jsxs("div", { className: "av-insights", children: [_jsxs("div", { className: "panel stat", children: [_jsx("div", { className: "k", children: "Time reclaimed" }), _jsx("div", { className: "v", children: availabilityInsights.reclaimed }), _jsx("div", { className: "d", children: "of focus saved this week" })] }), _jsxs("div", { className: "panel stat", children: [_jsx("div", { className: "k", children: "Conflicts resolved" }), _jsx("div", { className: "v", children: availabilityInsights.conflicts }), _jsx("div", { className: "d", children: "quietly rescheduled in advance" })] }), _jsxs("div", { className: "panel stat", children: [_jsx("div", { className: "k", children: "Buffer added" }), _jsx("div", { className: "v", children: availabilityInsights.buffer }), _jsx("div", { className: "d", children: "between back-to-backs" })] })] })] })] })] })), section === "event-types" && (_jsxs("div", { className: "dash-section et-surface", children: [_jsxs("section", { className: "et-hero", children: [_jsxs("div", { className: "et-hero-copy", children: [_jsx("span", { className: "eyebrow", children: "Reusable templates" }), _jsxs("h2", { children: ["Event links that stay ", _jsx("em", { children: "consistent." })] }), _jsx("p", { children: "Every template is a public booking link with its own scheduling rules. Share one, and BunnyCal keeps the flow in order." }), _jsxs("div", { className: "et-hero-meta", children: [_jsxs("div", { className: "et-stat", children: [_jsx("span", { className: "n", children: events.length }), _jsx("span", { className: "l", children: "templates" })] }), _jsxs("div", { className: "et-stat", children: [_jsx("span", { className: "n", children: events.length }), _jsx("span", { className: "l", children: "active" })] }), _jsxs("div", { className: "et-stat", children: [_jsx("span", { className: "n", children: "0" }), _jsx("span", { className: "l", children: "hidden" })] })] })] }), _jsx("div", { className: "et-bunny-stage", "aria-hidden": "true", children: _jsx(BunnyMascot, {}) })] }), _jsxs("div", { className: "et-listhead", children: [_jsxs("div", { children: [_jsx("span", { className: "eyebrow", children: "Your templates" }), _jsxs("h3", { children: ["Reusable ", _jsx("em", { children: "templates" })] }), _jsx("p", { children: "Public booking links with consistent scheduling behavior." })] }), _jsx(Link, { to: "/onboarding/event", className: "create", children: "Create event \u2192" })] }), eventsError && (_jsxs("div", { className: "dash-alert error", children: [_jsx("span", { children: eventsError }), _jsx("button", { className: "dash-btn-secondary", style: { fontSize: 12.5, padding: "5px 12px" }, onClick: () => void loadEventTypes(), children: "Retry" })] })), eventsLoading ? (_jsx("div", { className: "et-list", children: Array.from({ length: 4 }).map((_, i) => _jsx("div", { className: "dash-skel", style: { height: 64 } }, i)) })) : events.length === 0 ? (_jsxs("div", { className: "mt-empty", children: [_jsx("div", { className: "seed" }), _jsx("h4", { children: "No event types yet" }), _jsx("p", { children: "Create one event and your reusable booking links will appear here." }), _jsx(Link, { to: "/onboarding/event", className: "dash-btn-primary", style: { marginTop: 18 }, children: "Create event" })] })) : (_jsx("div", { className: "et-list", children: events.map((event, idx) => {
                                    const tones = ["c-lilac", "c-peach", "c-sage", "c-blush", "c-butter", "c-sky"];
                                    const tone = tones[idx % tones.length];
                                    const url = bookingUrl(event);
                                    return (_jsxs("article", { className: clsx("et-card", tone), children: [_jsx("span", { className: "et-glyph", children: event.name.trim().slice(0, 1).toUpperCase() }), _jsxs("div", { className: "et-meta", children: [_jsx("span", { className: "nm", children: event.name }), _jsxs("span", { className: "et-slug", children: [_jsx("span", { className: "host", children: "bunnycal.com" }), _jsxs("span", { className: "path", children: ["/", event.slug] })] })] }), _jsxs("div", { className: "et-actions", children: [_jsx("button", { className: clsx("et-btn", "copy", copiedEventId === event.id && "copied"), onClick: () => void handleCopyEventLink(event.id, url), children: copiedEventId === event.id ? "Copied" : "Copy link" }), _jsx("a", { href: url, target: "_blank", rel: "noreferrer", className: "et-btn", children: "Preview" }), _jsx(Link, { to: "/onboarding/event", className: "et-btn config", children: "Configure" })] })] }, event.id));
                                }) }))] })), section === "integrations" && (_jsx(DashboardIntegrationsSection, { banner: banner, integrationsError: integrationsError, clearBanner: clearBanner, integrationsLoading: integrationsLoading, refreshStatus: refreshStatus, pendingAction: pendingAction, calendarStatus: calendarStatus, calendarConnections: calendarConnections, conferencingRuntime: conferencingRuntime, conferencingStatus: conferencingStatus, calendarCapabilities: calendarCapabilities, conferencingCapabilities: conferencingCapabilities, getCalendarProviderStatus: getCalendarProviderStatus, getConferencingProviderStatus: getConferencingProviderStatus, onRequestDisconnect: (kind, provider) => setDisconnectTarget({ kind, provider }), onConnectCalendar: connectCalendar, onConnectConferencing: connectConferencing })), section === "event-editor" && (_jsx(DashboardEventEditorSection, { events: events, eventsLoading: eventsLoading, eventsError: eventsError, onReload: loadEventTypes })), section === "linked-accounts" && (_jsx(DashboardLinkedAccountsSection, {})), section === "participation" && (_jsx(DashboardParticipationSection, {})), section === "settings" && (_jsx("div", { className: "dash-section", children: _jsxs("div", { className: "split-grid", children: [_jsxs("div", { className: "panel", children: [_jsx("div", { className: "h", children: _jsxs("div", { children: [_jsx("h3", { children: "Event types" }), _jsx("div", { className: "sub", children: "Reusable booking templates and links" })] }) }), _jsx(Link, { to: "/dashboard/event-types", className: "dash-btn-secondary", style: { width: "fit-content" }, children: "Manage \u2192" })] }), _jsxs("div", { className: "panel", children: [_jsx("div", { className: "h", children: _jsxs("div", { children: [_jsx("h3", { children: "Integrations" }), _jsx("div", { className: "sub", children: "Calendar and conferencing connections" })] }) }), _jsx(Link, { to: "/dashboard/integrations", className: "dash-btn-secondary", style: { width: "fit-content" }, children: "Manage \u2192" })] })] }) }))] }), selectedMeeting && (_jsxs(Dialog, { open: true, onClose: () => setSelectedMeeting(null), title: `${selectedMeeting.guestName} · ${selectedMeeting.eventTypeName}`, width: "lg", footer: _jsxs("div", { className: "flex flex-wrap gap-2 w-full", children: [buildInvitationActions({
