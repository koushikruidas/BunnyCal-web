...
export function DashboardPage() {
    ...
    const { calendarStatus, calendarConnections, conferencingStatus, calendarCapabilities, conferencingCapabilities, loading: integrationsLoading, error: integrationsError, banner, clearBanner, getCalendarProviderStatus, getConferencingProviderStatus, startConnect, disconnectProvider, pendingAction, refreshStatus, } = useIntegrationState();
