...
export function GuestSlotPicker({ username, eventTypeSlug, hostKind = "authenticated-host", today, initialDate, selectedSlot, onSelectSlot, onContinue, continueLabel = "Continue", durationMinutes = 30, }) {
    const [dateKey, setDateKey] = useState(initialDate ?? dateKeyFromDate(today));
    ...
    const hasSelectedValidSlot = !!selectedSlot &&
