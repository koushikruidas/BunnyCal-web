...
export function DetailsView({ onBack, hostKind = "authenticated-host" }) {
    ...
    const handleSignIn = async () => {
        try {
            ...
            let loginUrl = selected?.authorizationPath
