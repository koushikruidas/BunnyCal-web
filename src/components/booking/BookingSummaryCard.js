...
export function BookingSummaryCard({ bookingId, eventName, hostName, startTime, durationMinutes, timezone, attendeeName, attendeeEmail, conferenceJoinUrl, status, statusLabel, header, children, className, }) {
...
function ConferenceLinkRow({ conferenceJoinUrl, status }) {
