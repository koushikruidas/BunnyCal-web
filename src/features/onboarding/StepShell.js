...
export function StepShell({ steps, currentStep, stepComplete, onStepChange, error, onBack, onNext, onPublish, publishing, publishLabel = "Publish event", children, }) {
    ...
    return (_jsx(SplitPane, { aside: _jsx(Stepper, { steps: steps, currentStep: currentStep, stepComplete: stepComplete, onStepChange: onStepChange }), asideWidth: "default", gap: 5, children: _jsxs("div", { className: "rounded-3xl border border-[#dbe4f8] bg-white p-5 md:p-8 shadow-[0_14px_40px_rgba(15,23,42,0.06)]", children: [_jsxs("p", { className: "text-xs uppercase tracking-[0.16em] text-[#64748b]", children: ["Step ", currentStep + 1, " of ", steps.length] }), _jsx("h1", { className: "mt-2 text-2xl font-semibold tracking-tight text-[#0f172a]", children: steps[currentStep] }), error && _jsx("p", { className: "mt-3 text-sm text-[#dc2626]", children: error }), children, _jsxs(Inline, { gap: 3, align: "center", justify: "between", className: "mt-8", children: [_jsx("button", { type: "button", onClick: onBack, disabled: currentStep === 0 || publishing, className: "rounded-xl border border-[#d1d5db] bg-white px-4 py-2 text-sm disabled:opacity-50", children: "Back" }), isLast ? (_jsx("button", { type: "button", onClick: onPublish, disabled: publishing, className: "rounded-xl bg-[#0f172a] px-5 py-2 text-sm font-medium text-white disabled:opacity-60", children: publishing ? "Publishing..." : publishLabel })) : (_jsx("button", { type: "button", onClick: onNext, className: "rounded-xl bg-[#0f172a] px-5 py-2 text-sm font-medium text-white", children: "Next" }))] })] }) }));
}
